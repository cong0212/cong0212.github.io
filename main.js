...
const app = {
    ...
    listSong: [
        ...
        {
            name: 'Vùng Ký Ức',
            singer: 'Chillies Official',
            img: './img/img3.jpg',
            linkMusic: './music/Vùng Ký Ức  Chillies Official Music Video.mp3'
        },
        {
            name: 'Mascara',
            singer: ' Chillies x BLAZE',
            img: './img/img3.jpg',
            linkMusic: './music/Mascara  Chillies x BLAZE  OFFICIAL MUSIC VIDEO.mp3.webm'
        },
    ],
